...
export const BACKGROUND_CANDIDATES: readonly BackgroundCandidate[] = [
  { key: 'aurora-flow', label: 'Aurora', blurb: 'Drifting curtains — band width ∝ each emotion’s share.', Component: AuroraFlow },
  { key: 'gradient-mesh', label: 'Mesh', blurb: 'Soft blobs, one per emotion — blob area ∝ share.', Component: GradientMesh },
  { key: 'plasma-conic', label: 'Plasma', blurb: 'A slow wheel — arc sweep ∝ share.', Component: PlasmaConic },
  { key: 'particle-field', label: 'Dust', blurb: 'Particle dust — count per emotion ∝ share.', Component: ParticleField },
  { key: 'strata-waves', label: 'Strata', blurb: 'Stacked strata — band height ∝ share.', Component: StrataWaves },
]

export type { BackgroundCandidate, EmotionBackground, EmotionBackgroundProps, EmotionSlice } from './emotion-field.ts'
