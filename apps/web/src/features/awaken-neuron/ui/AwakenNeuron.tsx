...
import { type LatentField, useLatentConsumedStore } from '../../../entities/latent-star/index.ts'
import { useAwakenRegistryStore } from '../model/awaken-registry.ts'
import { pickAwakenSeeds, type AwakenAnchor } from '../model/pick-awaken-seed.ts'
...
// with a sin(πp) grow-then-hand-off envelope and is gone as the real cell-star takes over.
const AWAKEN_BODY_ID = 'awaken-pulse'
const AWAKEN_CAPACITY = 32
