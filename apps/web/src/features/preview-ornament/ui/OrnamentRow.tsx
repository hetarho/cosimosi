...
// the view model it reads carries no `owned` field to render.
//
  ...
  return (
    <li>
      <button
        ...
        className={`flex w-full items-baseline justify-between gap-3 rounded-md px-3 py-2 text-left text-sm hover:bg-surface-hover disabled:opacity-60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus-ring ${
