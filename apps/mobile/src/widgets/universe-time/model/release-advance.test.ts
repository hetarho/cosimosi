...
// awaken announce and the clock landing are what "after the acceleration" means in code. This is a
// byte-for-byte fork of the web release-advance; the [I10] never-rewind guard is pinned on both.
describe('releaseAdvance', () => {
  ...
  it('never rewinds the clock ([I10]): a stale release below a newer value is ignored', () => {
    ...
    releaseAdvance({
      interval: { previous: '2026-07-01', current: '2026-07-10' },
      revealNeuronIds: [],
    })
