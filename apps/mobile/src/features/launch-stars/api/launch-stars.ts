...
import { createMemoryClient, type LaunchStarsResponse } from '@cosimosi/api-client'
...
export async function requestLaunchStars(transport: Transport, input: LaunchStarsInput): Promise<LaunchStarsResponse> {
