...
// overlay. SMALL (today's recall-only allowance) and GENERAL (the universal permanent
// reserve) are shown distinctly, the derived total is the headline. SMALL is always granted
// ([G5]), so a resolved read is never an empty state — a placeholder shows only until the
// first GetBalance settles. Figures only: no meaning-layer or placement control ([I11]).
