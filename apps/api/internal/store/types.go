...
// OrnamentKind is the closed set of surfaces decoration opens: the sky behind the universe, and the
// body shape a memory is shown as. A fourth kind cannot appear without amending this enum, the DDL CHECK and the
// proto in one reviewed change — and nothing meaning-bearing (a position, a strength, an emotion, a
// forgetting stage, a gist) is expressible as a kind at all ([P4][V10][I11]).
//
