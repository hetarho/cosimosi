...
export { Mood, MemoryService, RecordSchema, StarSchema, SynapseSchema } from './gen/cosimosi/v1/memory_pb'
export type { Star, Record, Synapse, GetUniverseResponse } from './gen/cosimosi/v1/memory_pb'
