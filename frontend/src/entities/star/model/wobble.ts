...
// 순수 — three/React/DOM 미의존(헌법 §4). 수치는 spec/values.yaml(wobble) 생성 상수.
import { VALUES } from '@/shared/config'

export const WOBBLE_AMP = VALUES.wobble.amp

/** 축별 [base, seedGain] 각주파수(rad/s) — freq = base + seed·gain (주기 대략 14~40초). */
export const WOBBLE_FREQ: readonly (readonly [number, number])[] = VALUES.wobble.freq

/** 축별 위상 배수 — phase = seed·2π·multiplier (별마다·축마다 다른 시작점). */
export const WOBBLE_PHASE: readonly number[] = VALUES.wobble.phase
