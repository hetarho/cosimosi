...
// Three TSL accepts Node-like values across its DSL, but the published TS overloads
// are narrower than the runtime graph API. Keep that mismatch contained here.
