...
export const VALUES = {
  ...
  rendering: {
    ...
    awakenMaxStepS: 0.05,
    spotlightHoldS: 4.5,
    spotlightFadeLambda: 3.4,
    spotlightSceneDim: 0.22,
    spotlightStarLift: 4,
  ...
  ui: {
    sheetBreakpointRem: 48,
    sheetDialogDismissPx: 96,
    sheetResizeDismissPx: 72,
    sheetFlickPx: 24,
    sheetFlickVelocityPxPerMs: 0.5,
    sheetSettleMs: 200,
    sheetTallestViewportRatio: 0.7,
    sheetShortestViewportRatio: 0.3,
    sheetTapPx: 6,
  },
  nebula: {
