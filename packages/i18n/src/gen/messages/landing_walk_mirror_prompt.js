...
const en_landing_walk_mirror_prompt = /** @type {(inputs: Landing_Walk_Mirror_PromptInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`What you often return to holds more of the sky. Watch what a few more recalls of the same star do.`)
};

const ko_landing_walk_mirror_prompt = /** @type {(inputs: Landing_Walk_Mirror_PromptInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`자주 돌아본 기억은 하늘에서 더 넓은 자리를 가져요. 같은 별을 몇 번 더 떠올리면 어떻게 되는지 보세요.`)
};

/**
* | output |
* | --- |
* | "What you often return to holds more of the sky. Watch what a few more recalls of the same star do." |
*
