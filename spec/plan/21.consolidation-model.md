# 21. consolidation-model

> consolidation-model — Nightly sleep pass: co-reactivation/redistribution, gist abstraction, schema binding, synaptic downscaling (weaken, never delete). | Scope: FS | Status: skeleton — author via /cosimosi:create-plan
> Tag: CONCEPT · Supersedes (.mvp): 27
