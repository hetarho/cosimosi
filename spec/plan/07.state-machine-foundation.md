...
> state-machine-foundation — XState v5 catalog, control-state vs data split, R3F per-frame getSnapshot rules. | Scope: FE | Status: skeleton — author via /cosimosi:create-plan
> Tag: CAPTURE/DEBT · Supersedes (.mvp): tech/state-machines (R003)
