# 12. engram-domain-model

> engram-domain-model — 2-layer model: cells (elements) + memories (ensembles) + connection = shared cells. Pure types and invariants. | Scope: FS | Status: skeleton — author via /cosimosi:create-plan
> Tag: CONCEPT/NEW · Supersedes (.mvp): new (code is single-layer)
