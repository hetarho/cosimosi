# 37. customization-skins

> customization-skins — 4-axis appearance (background/star/self/synapse), ownership/stardust, shader and model skins sold via the asset-source port; theme to background cleanup. | Scope: FS | Status: skeleton — author via /cosimosi:create-plan
> Tag: DEBT · Supersedes (.mvp): 44, 51, 52 + R006
