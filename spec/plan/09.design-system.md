...
> design-system — Tailwind tokens, shared/ui primitives, theme to background cleanup (R006), reduced-motion a11y, voice-tone copy. | Scope: FE | Status: skeleton — author via /cosimosi:create-plan
> Tag: NEW/DEBT · Supersedes (.mvp): policy/ux + code-review R006
