...
> demo-experience — Virtual clock, 30-day genesis sim, free mode + guided tour, production-logic parity. | Scope: FE | Status: skeleton — author via /cosimosi:create-plan
> Tag: DEBT · Supersedes (.mvp): 19, 47, 48
