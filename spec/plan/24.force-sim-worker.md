...
> force-sim-worker — Wire the pure force-sim into a Web Worker; feed coordinates to render (no React state at 60fps). | Scope: FE | Status: skeleton — author via /cosimosi:create-plan
> Tag: CAPTURE · Supersedes (.mvp): 07
