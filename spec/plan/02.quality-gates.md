...
> quality-gates — Lint / steiger / vitest / tsc / go-vet gates plus the invariant gate; refresh stale SSOT references. | Scope: Infra | Status: skeleton — author via /cosimosi:create-plan
> Tag: CAPTURE/DEBT · Supersedes (.mvp): tech/quality-gates (R003/R004)
