...
> i18n-paraglide — Paraglide setup, message catalogs, locale switching; all user-facing strings behind a seam (Korean-first, RN-shareable). | Scope: FE | Status: skeleton — author via /cosimosi:create-plan
> Tag: NEW · Supersedes (.mvp): none (the one gap)
