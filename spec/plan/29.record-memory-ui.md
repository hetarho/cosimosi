...
> record-memory-ui — features/record-memory: writing form -> optimistic star -> fan-out to cells. | Scope: FE | Status: skeleton — author via /cosimosi:create-plan
> Tag: CONCEPT · Supersedes (.mvp): 10
