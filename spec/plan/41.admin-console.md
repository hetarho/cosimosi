...
> admin-console — LLM key/provider config, ops dashboard, user list + stardust grant. | Scope: FS | Status: skeleton — author via /cosimosi:create-plan
> Tag: CAPTURE · Supersedes (.mvp): 34, 46
