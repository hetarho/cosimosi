...
> recall-reinforce — Deliberate recall button, read-only peek, Hebbian co-recall reinforce, reconsolidation + spreading-activation / retrieval-induced suppression. | Scope: FS | Status: skeleton — author via /cosimosi:create-plan
> Tag: CAPTURE/NEW · Supersedes (.mvp): 11 + change 35
