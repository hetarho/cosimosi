...
> data-persistence — Postgres + pgvector + goose + sqlc, repository-port discipline. | Scope: BE | Status: skeleton — author via /cosimosi:create-plan
> Tag: CAPTURE · Supersedes (.mvp): 03
