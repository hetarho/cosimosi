# 27. synapse-rendering

> synapse-rendering — entities/synapse: Line2 fat-lines, weight -> thickness/brightness/pulse; reconciled with cell-sharing semantics. | Scope: FE | Status: skeleton — author via /cosimosi:create-plan
> Tag: CAPTURE/CONCEPT · Supersedes (.mvp): 09
