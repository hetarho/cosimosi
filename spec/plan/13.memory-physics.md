...
> memory-physics — Deterministic pure functions: brightness decay, size=strength, lambda_eff, PE-gated reshaping, abstraction stage, link weight, Hebbian; demo=prod golden parity. | Scope: FS | Status: skeleton — author via /cosimosi:create-plan
> Tag: CONCEPT/DEBT · Supersedes (.mvp): shared/lib/memory-physics
