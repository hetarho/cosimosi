...
> universe-canvas — widgets/universe-canvas: <Canvas>, WebGPURenderer, camera, Bloom. | Scope: FE | Status: skeleton — author via /cosimosi:create-plan
> Tag: CAPTURE · Supersedes (.mvp): 06
