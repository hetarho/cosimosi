# 20. async-pipeline-model

> async-pipeline-model — extract -> embed -> link -> consolidate jobs, queue semantics, idempotency, backoff. | Scope: BE | Status: skeleton — author via /cosimosi:create-plan
> Tag: CAPTURE · Supersedes (.mvp): 05
