# 17. spatial-layout-model

> spatial-layout-model — Center=self, radius=connectedness (not time/forgetting), angle=relationship. Coordinates emergent client-side; only form drifts. | Scope: FE | Status: skeleton — author via /cosimosi:create-plan
> Tag: CONCEPT · Supersedes (.mvp): 38
