...
> emotion-model — 13-mood valence/arousal taxonomy; color and intensity mapping rules (emotion drives color only, never position). | Scope: FS | Status: skeleton — author via /cosimosi:create-plan
> Tag: CAPTURE · Supersedes (.mvp): 29
