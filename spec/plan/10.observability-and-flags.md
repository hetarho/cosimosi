...
> observability-and-flags — Sentry + PostHog, error boundaries, BE validation/limits/panic recovery, analytics consent + feature flags (PostHog). | Scope: FS | Status: skeleton — author via /cosimosi:create-plan
> Tag: CAPTURE/NEW · Supersedes (.mvp): 17, 18 + flags new
