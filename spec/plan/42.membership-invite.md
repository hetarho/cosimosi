# 42. membership-invite

> membership-invite — Invite-code membership gate, sign-in visuals, issuance console. | Scope: FS | Status: skeleton — author via /cosimosi:create-plan
> Tag: CAPTURE · Supersedes (.mvp): 41
