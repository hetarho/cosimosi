# 19. render-asset-source-port

> render-asset-source-port — Port for star/cell/synapse visual body: TSL shader | imported 3D model (glTF) | future sources. Shader-art toolkit becomes one adapter. | Scope: FE | Status: skeleton — author via /cosimosi:create-plan
> Tag: NEW · Supersedes (.mvp): extends 42, 50
