# 18. ai-provider-ports

> ai-provider-ports — Embedder + Extractor ports/adapters, admin-selected, keyless mock fallback, cost metering. | Scope: BE | Status: skeleton — author via /cosimosi:create-plan
> Tag: CAPTURE · Supersedes (.mvp): tech/llm, 20, 34
