...
> rpc-transport — proto single contract, Connect server/client (unary), interceptors, connect-query. | Scope: FS | Status: skeleton — author via /cosimosi:create-plan
> Tag: CAPTURE · Supersedes (.mvp): 02
