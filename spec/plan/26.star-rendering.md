...
> star-rendering — entities/star: InstancedMesh buckets (look x abstraction stage), body via asset-source port; brightness/size/color/form mapping. | Scope: FE | Status: skeleton — author via /cosimosi:create-plan
> Tag: CAPTURE/DEBT · Supersedes (.mvp): 08, 42, 53
