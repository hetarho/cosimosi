...
> auth-session — Supabase Auth + session state machine, user_id isolation, JWT verification. | Scope: FE | Status: skeleton — author via /cosimosi:create-plan
> Tag: CAPTURE · Supersedes (.mvp): 01, 02
