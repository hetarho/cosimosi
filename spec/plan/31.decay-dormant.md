...
> decay-dormant — Dimming with A_MIN floor; dormant-star browse (never deleted). | Scope: FS | Status: skeleton — author via /cosimosi:create-plan
> Tag: CAPTURE · Supersedes (.mvp): 12
