...
> cosmos-scene — widgets/cosmos-scene: shared reusable scene (background + stars + bloom) for sign-in/landing/studio. | Scope: FE | Status: skeleton — author via /cosimosi:create-plan
> Tag: CAPTURE · Supersedes (.mvp): 43
