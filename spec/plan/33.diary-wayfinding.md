...
> diary-wayfinding — Original diary <-> engram <-> star navigation; immutable original view. | Scope: FS | Status: skeleton — author via /cosimosi:create-plan
> Tag: CAPTURE · Supersedes (.mvp): 28
