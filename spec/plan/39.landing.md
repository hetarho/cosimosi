...
> landing — Public landing, neuroscience arc, fantastical universe viz; copy reconciled with concept section 10 guardrails + canonical values. | Scope: FE | Status: skeleton — author via /cosimosi:create-plan
> Tag: CAPTURE/DEBT · Supersedes (.mvp): 15
