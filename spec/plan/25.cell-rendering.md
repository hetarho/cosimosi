...
> cell-rendering — Render engram cells as small stars (InstancedMesh) via the asset-source port — the 2-layer visual tier. | Scope: FE | Status: skeleton — author via /cosimosi:create-plan
> Tag: NEW/CONCEPT · Supersedes (.mvp): new
