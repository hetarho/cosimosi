...
> linking-model — Connection strength = shared-cell overlap (+ semantic/temporal as predictive signals). Emotion never used for position or links. | Scope: FS | Status: skeleton — author via /cosimosi:create-plan
> Tag: CONCEPT · Supersedes (.mvp): synapse policy + SSOT-AUDIT B3
