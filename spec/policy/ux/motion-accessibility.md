...
- R7: tech/overlay-shell.md · `shared/ui/{OverlayHost,BottomSheet,SidePanel,Backdrop}.tsx`·`shared/ui/use-coarse-pointer.ts`, `pages/home/ui/HomePage.tsx`(셸 합성·`useShellStore`·포커스 딤·일기 카드), `widgets/universe-canvas/ui/UniverseCanvas.tsx`(`onPointerMissed` 해제·ViewOffset 일기 시선↑), `features/diary-list/ui/DiaryCard.tsx`
