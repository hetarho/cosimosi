...
1. **Target** — the code-review number NN (`spec/code-review/NN.*.md`). Confirm it's a filled report (findings R001…),
   not a bare template. If empty, send the user back to /cosimosi:create-code-review first.
...
6. Report the job path + "Next: `/cosimosi:implement-job MM`". Do NOT implement or commit.
